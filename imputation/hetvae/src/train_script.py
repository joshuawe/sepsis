...
for mse_weight in [35]: # [10, 13 , 16, 19, 25, 30, 35, 45]:

    model_args = f'--niters 250 --lr 0.0001 --batch-size 128 --rec-hidden 128 --latent-dim 128 --width 128 --embed-time 128 --enc-num-heads 1 --num-ref-points 16 --n 8000 --dataset {dataset} --seed 1 --save --norm --intensity --net hetvae --bound-variance  --sample-tp 0.85 --elbo-weight 1.0 --mse-weight {mse_weight} --mixing concat --k-iwae 10'
